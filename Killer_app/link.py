...
def get_actions(actionfile="actions_fr.txt"):
    """ Return actions as a list from file ac¬tions.txt """
    with open(os.path.join(BASE, actionfile), "r",encoding="utf-8") as file_actions:
